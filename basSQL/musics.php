        ...
        <div class="music-container">
            <?php foreach ($musics as $music): ?>
                <div class="music-card">
                    <img src="<?php echo htmlspecialchars($music['album_cover']); ?>" alt="<?php echo htmlspecialchars($music['title']); ?>">
                    <h3><?php echo htmlspecialchars($music['title']); ?></h3>
                    <p>Par <?php echo htmlspecialchars($music['artist']); ?></p>
                    <audio controls>
                        <source src="<?php echo htmlspecialchars($music['track_path']); ?>" type="audio/mpeg">
